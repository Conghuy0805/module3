create database csdl_quanlibanhang;
...
select o.oID,o.oDate,p.pPrice from Orders o
join OrderDetail odetail on o.oID = odetail.oID
join Product p on odetail.pID = p.pID;
...
select o.oID, o.Odate, sum(odQTY*pPrice) as 'Giá tiền'
from Orders o
join OrderDetail od on o.oID = od.oID 
join Product p on od.pID = p.pID
group by o.oID;